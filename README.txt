...
Install the Site verification module as you would normally install a contributed Drupal module. Visit https://www.drupal.org/docs/7/extending-drupal-7/installing-contributed-modules-find-import-enable-configure-drupal-7 for further information.
...
5. There is an option to provide a file, simply upload it under "Upload an existing verification file" and then under "Verification file" provide the name of the HTML file you uploaded.
6. A description of the verification file can be added to "Verification file contents". By default it reads, "This is a verification page."
7. Save.
